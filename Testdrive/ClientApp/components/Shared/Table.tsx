...
export const Table = (props: TableInfo) => {
    return props.rows.length > 0
        ? <div id={props.name} className="row">
        ...
        : <div className="m-auto pt-5" style={{'maxWidth':'290px'}}>
            <Greeting title={'Finns inga resultat att visa'} text={
                'Det finns inga resultat som matchar dina söktermer'} />
        </div>;
}
